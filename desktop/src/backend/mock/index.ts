...
import type { ChangeSource, Features } from '../types';
...
export function createMockBackend(opts:{latencyMs?:number}={}):Backend {
 const identity=structuredClone(design.ME);

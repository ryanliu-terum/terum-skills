...
it('replays the rebuilt fixture through Global and checkout scopes and Skill detail',async()=>{
  ...
  expect(detail.value).toMatchObject({desc:'a deploy needs a pre-flight checklist.',grants:[],users:[['seed','S','Global · since 2026-08-20'],['mira','MC','Global · since 2026-08-25']],skillMd:{markdown:'# deploy-check\n\nUse this skill when a deploy needs a pre-flight checklist.\n\n1. Step one.\n2. Step two.\n'},receipt:null,lines:6,favorites:null});

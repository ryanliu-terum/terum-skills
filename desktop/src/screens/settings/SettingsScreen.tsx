...
export function SettingsScreen(){
  ...
  return <Shell selected="Settings" counts={loading||error?null:undefined}><ScreenFrame ready={(!query.isPending||state.mock==='loading')&&!status.isPending&&(section!=='teams'||!catalog.isPending||state.mock==='loading')&&(section!=='updates'||!!error||state.mock==='loading'||(!update.isPending&&!capabilities.isPending))}><WorkflowHeader title="Settings" icon="settings"/>

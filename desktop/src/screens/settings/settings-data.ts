...
export const settingsSections: readonly [string,string,IconName][] = [
 ['account','Account','user'],['teams','Team','users'],['machine','This machine','laptop'],['sync','Sync','refresh'],['updates','Updates','arrow-up-circle'],['inbox','Inbox','inbox'],['evals','Evals','flask'],['sharing','Sharing','upload'],['appearance','Appearance','sun'],['advanced','Advanced','sliders'],['about','About','info'],
];

...
/** The three D6 dialogs share the CLI's typed-name confirmation. The workflow is the PAGE's (SkillScreen),
...
export function SkillFileDialog({kind,skill,workflow,onClose,onDone}:{kind:'move'|'rename'|'delete';skill:SkillDetail;workflow:ReturnType<typeof useWorkflow>;onClose:()=>void;onDone:(value:SkillFileResult)=>void}) {

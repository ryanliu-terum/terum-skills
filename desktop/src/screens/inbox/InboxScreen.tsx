...
export function InboxScreen() {
  ...
  const error = actionError ?? (query.data?.ok === false ? query.data.error : query.isError ? query.error.message : null);

...
import { driveRun, PrintContext, PromptContext, useBackend, useCapabilities } from '../../backend';
...
export function InboxScreen() {
  ...
  const items = query.data?.ok ? query.data.value.filter(it=>capabilities?.offtargetKind||it.sub!=='offtarget') : [], item = items.find(it => it.id === state.inboxSelectedId);

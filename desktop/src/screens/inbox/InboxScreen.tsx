...
export function InboxScreen() {
  ...
  const enabled={share:usePreference('inbox:kind:share',true),update:usePreference('inbox:kind:update',true),alert:usePreference('inbox:kind:alert',true),eval:usePreference('inbox:kind:eval',true),review:usePreference('inbox:kind:review',true),author:usePreference('inbox:kind:author',true),team:usePreference('inbox:kind:team',true)};

...
/** The bare 16px box alone — for a host that draws its own label (a selectable card). Same base-ui root and `.checkbox` class as the labelled row. */
export function CheckboxBox(props:ComponentProps<typeof Base.Root>){return <Base.Root {...props} className="checkbox"><Base.Indicator><Icon name="check" size={12} color="#fff" stroke="3"/></Base.Indicator></Base.Root>;}

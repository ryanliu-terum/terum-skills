...
export function Shell({selected='Global',counts,overlay,children,roots}:PropsWithChildren<{selected?:string;counts?:Record<string,string>|null|undefined;overlay?:ReactNode;roots?:readonly Root[]|undefined}>){

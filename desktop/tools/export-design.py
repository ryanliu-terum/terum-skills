...
NAMES = ['TOKENS', 'SKILLS', 'INBOX', 'CATALOG', 'MARKET_EXTRA', 'PEOPLE', 'ROSTER_MORE', 'ROSTER', 'PROJECTS', 'MEMBER', 'INVITED', 'CATEGORIES', 'DETAIL', 'DETAIL_PARTIAL', 'DETAIL_NO_RECEIPT', 'DETAIL_NOT_INSTALLED', 'AUTHOR_OF', 'LIST_OF', 'COUNTS', 'KINDS', 'CATALOG_N', 'TEAM_N', 'HOVER_INDEX', 'INBOX_UNREAD', 'PROVENANCE', 'K', 'DEFAULT_CASES', 'RYAN', 'AJAY', 'MIRA', 'KAI', 'TEDDY', 'LENA', 'TAB_ITEMS', 'METHOD', 'FILTER_DEFAULT', 'INVITEE', 'TEAM_REPO', 'INVITE_TIP', 'VERDICT_STYLE', 'INDICATORS', 'MACHINE', 'ME', 'TEAMS', 'TEAM_POLICY', 'PLACEMENTS', 'PLACEMENTS_N', 'PINNED_N', 'APPROVALS', 'QUARANTINE', 'SHARED', 'LOCAL_UNSHARED', 'HOOK', 'APP_VERSION', 'AGENT_CLI', 'COMMUNITY', 'STORAGE', 'SETTINGS_NAV', 'SHORTCUTS', 'INBOX_KIND_TEXT', 'THEME_OPTIONS', 'ONBOARD_STEPS', 'ONBOARD_BASICS', 'GLOBAL_SET', 'ONBOARD_PLACED', 'ONBOARD_LATER', 'ONBOARD_COMMUNITY', 'ONBOARD_FETCH_ERROR', 'WELCOME_LINES', 'BASICS_COPY', 'BASICS_HINT', 'ICON_PATHS', 'TERUM_MARK']

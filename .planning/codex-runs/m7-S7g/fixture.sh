...
set -euo pipefail
FX=${1:?fixture root}; CLI=/Users/ryanliu/Documents/Terum/terum-codex/m7-S7g/dist/index.js
...
# The health probe needs a real ledger fingerprint, not the original placeholder.

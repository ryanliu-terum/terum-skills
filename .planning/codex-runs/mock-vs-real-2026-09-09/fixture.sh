...
# The team the 2026-09-09 mock-vs-real captures show: acme with mira/ravi/seed (no roles, no project membership),
# deploy-check/tdd/diagnose at the 1111/2222/3333 ids, seed's deploy-check placed globally — the m7-S7ad fixture
# shape, seeded directly in layout 3 (skills/<name>/v1/, team.json layout_version 3, projects.Global).
...
export GIT_AUTHOR_DATE='2026-09-09T01:33:11-07:00' GIT_COMMITTER_DATE='2026-09-09T01:33:11-07:00'
...
J
# No receipt was ever committed for this team: every eval-report frame shows an empty history and no local run.

...
**Status:** DRAFT rev 7 (2026-09-11). §2 records twenty-four rulings. §15 is empty — every open question was walked to a resolution.
...
| `.planning/specs/2026-09-10-auto-category.md` | locked, **amended** | Survives with its wiring moved: the suggestion happens once, at the **first publish** (§5.1 step 4), with the sibling's precedence, its `--category` flag and its disclosure table unchanged (declared → no line), and is written into the user's local folder (§5.1 step 5). Its §4 ("Wiring into `connect`") and §7 ("at connect") are amended by this spec — see the note at its head. |

...
- 2026-09-10 amendment (D9, f-auto-sync): the app may act without being asked. D9 recorded that the app runs CLI work only on an explicit gesture; automatic sync runs at launch and on focus, throttled to ten minutes and single-flight, with no timer and no prompt. It never pushes anything a manual sync would not, and consent-needing work still lands in the Inbox. Authority: Teddy, 2026-09-10, "Sync should be automatic and much faster for the application (for all skills projects, etc)."

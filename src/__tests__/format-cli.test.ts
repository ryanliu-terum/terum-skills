...
const INVOCATIONS: Record<string, string[]> = {
  ...
  'project add': ['project', 'add'], 'project remove': ['project', 'remove', '/project'], 'project list': ['project', 'list'], 'team project create': ['team', 'project', 'create', 'Payments'], 'team project delete': ['team', 'project', 'delete', 'Payments'],
  ...
  invite: ['invite', 'u'], ls: ['ls'], status: ['status'], publish: ['publish', 'ref'], unpublish: ['unpublish', 'ref'], validate: ['validate', 'x'], eval: ['eval', 'x'], 'eval-report': ['eval-report', 'x'], install: ['install', 'ref'], 'uninstall-skill': ['uninstall-skill', 'ref'], uninstall: ['uninstall'], sync: ['sync'], prune: ['prune'], search: ['search', 't'], update: ['update'], reconcile: ['reconcile', '--list'],
};
...
const stubs = (verb: unknown): CliVerbs => ({ skill: verb, skillToggle: verb, unpublish: verb, project: verb, app: verb, profile: verb, login: verb, team: verb, setup: verb, install: verb, uninstall: verb, uninstallMachine: verb, sync: verb, prune: verb, search: verb, invite: verb, ls: verb, status: verb, readme: verb, publish: verb, leave: verb, guardPush: verb, validate: verb, eval: verb, evalReport: verb, update: verb, appUpdate: verb, reconcile: verb } as CliVerbs);

...
export const invocationLiteralCatalog: readonly { file: string; line: number; policy: 'routed' | 'fixed' | 'prose' | 'not-a-hint'; pattern: string }[] = [
  ...
  },
  {
    ...
    "line": 383,
    "policy": "prose",
    "pattern": "| | `team project delete [<name>] [--yes]` | Delete a team project: removes the membership list only. Every skill it named stays in the marketplace, so this is how a team retires the `Global` card older repos were created with |"
  },
  {
    "file": "README.md",
    "line": 384,

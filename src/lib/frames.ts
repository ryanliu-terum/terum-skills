...
export const FRAME_VERBS = ['login', 'setup', 'team create', 'team join', 'team remove', 'team leave', 'team workflow-update', 'invite', 'ls', 'status', 'publish', 'validate', 'eval', 'connect', 'install', 'uninstall-skill', 'uninstall', 'sync', 'search', 'update'] as const;
